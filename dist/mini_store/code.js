const custom = {
  ...
  sideload: [],
  description:
    "Integrate Rossum with Coupa. Automatically export Documents to Coupa, replicate Master Data in Rossum, and keep them up to date.",
  extension_source: "rossum_store",
  guide: "",
  read_more_url: null,
  extension_image_url:
    "https://rossum.s3.eu-west-1.amazonaws.com/rossum-store-assets/sap/Coupa+Integration.png",
  store_description:
